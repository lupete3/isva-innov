            ...
            <div class="row" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-12 d-flex justify-content-center mt-4">
                    <ul class="portfolio-filters isotope-filters">
                        ...
                        <li data-filter=".filter-mines">Mines & Énergie</li>
                        <li data-filter=".filter-services">Services & Commerce</li>
                        <li data-filter=".filter-ong">ONG & Projets</li>
                        <li data-filter=".filter-industry">Industrie</li>
                    </ul>
                </div>
            </div>
