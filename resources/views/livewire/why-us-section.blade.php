<section id="features" class="features section light-background">
    ...
    <div class="container section-title" data-aos="fade-up">
        ...
        <p>{{ $whyUs?->subtitle ?? 'Une expertise rigoureuse pour sécuriser votre avenir financier' }}</p>
            ...
            <div class="col-lg-5">
                <article class="intro-panel" data-aos="fade-right" data-aos-delay="200">
                    ...
                    <div class="intro-content">
                        <h3 class="intro-title">{{ $whyUs?->intro_title ?? 'Conçu pour votre Performance' }}</h3>
                        <p class="intro-text">{{ $whyUs?->intro_description ?? 'Nous optimisons vos processus financiers et RH pour vous permettre de vous concentrer sur votre cœur de métier.' }}</p>
