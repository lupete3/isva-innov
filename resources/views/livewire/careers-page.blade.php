          ...
          <div class="col-lg-10">
            ...
            <div class="job-listings mt-5">
              ...
              <div class="job-item p-4 mb-4 shadow-sm" data-aos="fade-up">
                <div class="row align-items-center">
                  ...
                  <div class="col-md-4 text-md-end mt-3 mt-md-0">
                    <a href="mailto:rh@isva-innov.cd?subject=Candidature: {{ $job->title }}" class="btn btn-primary px-4">Postuler</a>
                  </div>
                </div>
                <hr class="my-4">
              ...
              <div class="text-center py-5 bg-light rounded-4">
                ...
                <p>N'hésitez pas à nous envoyer votre candidature spontanée à <a href="mailto:rh@isva-innov.cd">rh@isva-innov.cd</a></p>
              </div>
              @endforelse
            </div>
          </div>
