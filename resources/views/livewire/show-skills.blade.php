        ...
        <div class="row align-items-center">
            <div class="col-lg-5">
                <div class="skills-header">
                    ...
                    <p>
                        {{ $skillHeader?->description ?? 'Nous mobilisons des compétences pointues pour répondre aux enjeux complexes de votre entreprise. Notre maîtrise des référentiels internationaux et locaux assure un service de haute qualité.' }}
                    </p>
