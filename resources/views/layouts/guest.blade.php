...
<head>
    <meta charset="utf-8">
    <title>@yield('title', 'ISVA-Innov - Service, Audit, Expertise Comptable')</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="ISVA-Innov, Audit, Expertise Comptable, Sous-traitance, RH, RDC" name="keywords">
    <meta content="Cabinet d'Audit, Expertise Comptable et Sous-traitance RH en République Démocratique du Congo." name="description">
